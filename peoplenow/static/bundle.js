...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(11), __webpack_require__(17), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function anonymous(locals, filters, escape, rethrow) {
	    ...
	    try {
	        ...
	        with (locals || {}) {
	            (function() {
	                buf.push('<div class="profile">\n\n	<section>\n		<h2 class="section-title">Facebook data (read only):</h2>\n		<form class="form">\n			<table>\n					<tr class="field">\n						<td><label class="label" for="name">User name</label></td>\n						<td>\n							<input class="input"\n										 type="text"\n										 name="name"\n										 value="', escape((__stack.lineno = 13, name)), '"\n										 readonly>\n						</td>\n					</tr>\n					<tr class="field">\n					  <td><label class="label" for="email">E-mail</label></td>\n					  <td>\n					  	<input class="input"\n					  				 type="email"\n					  				 name="email"\n					  				 value="', escape((__stack.lineno = 23, email)), '" \n					  				 readonly>\n					  </td>\n					</tr>\n				</table>\n		</form>\n	</section>\n\n	<section>\n		<h2 class="section-title">User tags:</h2>\n		<form class="form">\n			<table>\n					<tr class="field">\n					  <td><label class="label" for="tags">Tags:</label></td>\n						<td>\n							<!--select class="input" name="tags" multiple required>\n  							<option value="flash">Flash</option>\n  							<option value="html">HTML</option>\n  							<option value="css">CSS</option>\n							</select-->\n							<input type="hidden" value="', escape((__stack.lineno = 43, tags_string)), '">\n						</td>\n					</tr>\n			</table>\n			<input class="submit-button" type="submit" value="Save">\n		</form>\n	</section>\n\n</div>');
	            })();
	        }
	        return buf.join("");
	    } catch (err) {
